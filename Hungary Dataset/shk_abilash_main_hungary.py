...
mat_reduced,feat = Scatter_PCA(scal_features ,50)
mat_reduced.shape
...
print("\n\tACCURACY SCORE\n\t******************************\n")
print (f"\t{metrics.accuracy_score(y, y_preds)}")
